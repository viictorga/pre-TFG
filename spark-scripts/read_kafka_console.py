"""
Fase 3A: Spark Structured Streaming lee los eventos CDC de transacciones
del topic de Kafka y los muestra por consola. Todavia NO escribe en
Iceberg -- eso es la parte B.
